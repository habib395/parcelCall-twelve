...
const About = () => {
  ...
  return (
    <section id="about" className="bg-gray-50 dark:bg-gray-900 dark:text-white transition-all duration-300 py-4 sm:py-16 px-4 md:px-10">
      <SectionTitle heading="About Us" />

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-4 sm:mt-10 w-[95%] mx-auto">
        {items.map((item, index) => (
          <div
            key={index}
            className="bg-white dark:bg-gray-900 dark:text-white border border-gray-200 dark:border-gray-700 shadow-md rounded-2xl p-6 sm:p-8 lg:p-10  transform transition-all duration-300 hover:scale-105 hover:shadow-xl"
            data-aos={index % 2 === 0 ? "fade-up" : "fade-down"}
          >
            <div className="text-3xl hidden sm:block sm:text-5xl lg:text-7xl text-blue-500 mb-4">{item.icon}</div>
